    ...
    >
      ...
      >
        ...
        >
          <img
            src={heroCar}
            alt="Toyota Fortuner luxury SUV — KS Travels premium fleet"
            width={1920}
            height={1280}
      ...
      <div className="relative z-10 h-full flex flex-col justify-between max-w-7xl mx-auto px-5 pt-28 pb-10 pointer-events-none">
        <div className="pointer-events-auto max-w-2xl">
          ...
          >
            <span className="block gold-text-gradient drop-shadow-[0_4px_30px_rgba(201,168,76,0.3)]">KS</span>
          ...
          >
            Premium Car Rentals · Rajamahendravaram, Andhra Pradesh
          </motion.p>
