  ...
  return (
    <div className="flex items-center gap-3" style={{ transform: `scale(${size})`, transformOrigin: "left center" }}>
      ...
      <div className="flex flex-col leading-none">
        <span className="font-display font-black text-gold text-lg tracking-wide">KS</span>
        <span className="font-body text-[10px] tracking-[0.4em] text-gold/70">TRAVELS</span>
      </div>
    </div>
  );
}
