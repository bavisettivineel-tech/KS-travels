...
const items = [
  { icon: Star, title: "Perfect 5.0 Rating", desc: "31 verified Google reviews with perfect 5-star rating" },
...
export function WhyUs() {
  return (
    <Section id="why" label="Why Choose Us" title="The KS Travels Difference">
