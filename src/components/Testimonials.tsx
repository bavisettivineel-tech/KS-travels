...
const testimonials = [
  {
    text: "Excellent service! The driver was very professional and reached on time. The car was clean and comfortable. Highly recommend KS Travels for any trip from Kakinada.",
    name: "Ravi Kumar",
    location: "Kakinada",
